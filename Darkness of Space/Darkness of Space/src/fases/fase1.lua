...
local function victoryEnd()
    composer.gotoScene( "src.telas.victory", { time=1100, effect="crossFade"})
end    
...
local function generationItem()
    ...
    if (selectItem == 1) then
        ...
        player_attack1.x = math.random(25, 274)
        player_attack1.y = math.random(218, 483)
    ...
    elseif (selectItem == 2) then
        ...
        player_attack2.x = math.random(25, 274)
        player_attack2.y = math.random(218, 483)
...
function scene:hide( event )
	...
	elseif ( phase == "did" ) then
        ...
        physics.pause()
        audio.stop( 1 )
        composer.removeScene( "src.fases.fase1" )
	end
end
